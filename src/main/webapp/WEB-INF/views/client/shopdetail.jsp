    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="${image.pathLeft}" alt="Image">
                    </div>
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="${image.pathMiddle}" alt="Image">
                    </div>
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="${image.pathRight}" alt="Image">
                    </div>
                </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">Sizes: ${product.size}</strong>
                    <form>
